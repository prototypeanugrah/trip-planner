...
export function Layout() {
  ...
  return (
    <div className="min-h-screen flex relative text-text-primary">
      {/* Dynamic Background */}
      ...
      <main className="flex-1 min-w-0 flex flex-col">
        ...
        <header className="h-16 border-b border-border flex items-center px-4 md:px-8 sticky top-0 bg-bg-primary/80 backdrop-blur-md z-30 justify-between">
